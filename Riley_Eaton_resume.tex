...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\href{https://github.com/rileyeaton-ubc/COSC519-Jersey-Number-Recognition}{\textbf{Deep Learning Pipeline: Jersey Number Recognition} \faGithub} \hspace{\iconSpace}$|$ \textit{Python, PyTorch, OpenCV, Git}}{Sep 2025 -- Dec 2025}
          \resumeItemListStart
            \vspace{\projectSpaceBefore}
...
\vspace{2pt}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Technical Skills}{: Parallel Computing, Applied Computer Vision, Deep Learning Architectures, Relational Databases, NoSQL Databases (MongoDB), Data Pipelines, Medical Informatics, DICOM Standard, Unix/Linux, Fault Tolerance, Telemetry} \vspace{\proficiencySpace} \\ 
     ...
     \textbf{Languages}{: Python, MATLAB, R, C, CUDA, Arduino, $C\#$, Java, JavaScript, HTML, CSS, PHP, SQL, MIPS Assembly, LaTeX} \vspace{\proficiencySpace} \\
